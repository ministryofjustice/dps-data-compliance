...
COMMENT ON COLUMN REFERRED_OFFENDER_BOOKING.REFERRED_OFFENDER_BOOKING_ID IS 'Primary key id';
COMMENT ON COLUMN REFERRED_OFFENDER_BOOKING.OFFENDER_ID IS 'This is the primary key in NOMIS for the OFFENDERS table';
COMMENT ON COLUMN REFERRED_OFFENDER_BOOKING.OFFENDER_BOOK_ID IS 'This is the primary key in NOMIS for the OFFENDER_BOOKINGS table';
COMMENT ON COLUMN REFERRED_OFFENDER_BOOKING.REFERRAL_ID IS 'This links the ids here to the referred offender';
