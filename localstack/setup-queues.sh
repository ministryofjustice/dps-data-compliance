...
aws --endpoint-url=http://localhost:4576 sqs create-queue --queue-name inbound_referral_queue
aws --endpoint-url=http://localhost:4576 sqs create-queue --queue-name inbound_referral_dead_letter_queue
aws --endpoint-url=http://localhost:4576 sqs set-queue-attributes \
    --queue-url http://localhost:4576/queue/inbound_referral_queue --attributes file:///docker-entrypoint-initaws.d/inbound-referral-queue-attributes.json
