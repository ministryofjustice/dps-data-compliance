...
env:
  ...
  {{- if .Values.env.OFFENDER_RETENTION_SQL_DATA_DUPLICATE_CHECK_ENABLED }}
  - name: OFFENDER_RETENTION_SQL_DATA_DUPLICATE_CHECK_ENABLED
    value: "{{ .Values.env.OFFENDER_RETENTION_SQL_DATA_DUPLICATE_CHECK_ENABLED }}"
  {{- end }}

  {{- if .Values.env.OFFENDER_RETENTION_AP_DATA_DUPLICATE_CHECK_ENABLED }}
  - name: OFFENDER_RETENTION_AP_DATA_DUPLICATE_CHECK_ENABLED
    value: "{{ .Values.env.OFFENDER_RETENTION_AP_DATA_DUPLICATE_CHECK_ENABLED }}"
  {{- end }}
